...
%\VignetteIndexEntry{Wolves on the hunt in sheep depredation hotspots in France}
...
\title{Appendix B of the article: Wolves on the hunt in sheep depredation hotspots in France.}
